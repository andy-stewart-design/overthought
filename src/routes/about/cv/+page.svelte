...
<Container as="main" py="xl" class="grid gap-12 font-[375] max-w-3xl mx-auto bg-background">
	...
	<section class="grid gap-6">
		...
		<div class="text-lg leading-normal">
			Hi, I'm Andy, a designer working at the intersection of brand and technology. I have a decade
			of experience in helping brands realize even the most vague of ideas across a variety of
			touchpoints, from identities to digital experiences. My work is defined by a love of
