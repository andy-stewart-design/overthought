...
<main class="bg-background py-lg font-[375] px-app">
	<div class="mx-auto grid max-w-3xl gap-12">
		...
		<section class="grid gap-5 rounded-md border bg-surface-low p-4 border-light md:px-6 md:py-5">
			...
			<div class="leading-normal md:text-lg">
				...
				companies turn ideas into experiences across a variety of media and touchpoints, from visual identities and
				installations to websites and apps. My work is defined by a love of aesthetics, technology, and delightful
				interactions, and I have a track record of creating elegant design solutions that solve customer problems and
				meet business goals.
			</div>
		</section>
		...
		<section class="grid gap-8">
			{#each professionalExperiences as exp}
				<h3 class="text-sm font-medium">{exp.category}</h3>
